...
| **D6** | Justified research conclusions | every conclusion cites a registry row, a decision record or a commit · blanks never back-filled · automated indicators decide nothing · gate-1 scores hashed **before** unblinding, asserted by a test · the memory figure revised **tighter** on its own evidence | §6.3, §13, §19 |
...
| RQ | answered in | verdict |
|---|---|---|
| RQ1 | §9.2 | feasibility established; superiority **not claimed** |
| RQ2 | §9.1 | answered on **two** measured candidates |
| RQ3 | §10 | answered |
| RQ4 | §11.4 | captions answered; **image count inconclusive** |
| RQ5 | §11.4 | answered — per-style selected, multi-style viable |
| RQ6 | §11.2 | answered |
| RQ7 | §11.2, §11.4 | **partially** — rank and learning rate not swept |
| RQ8 | §9.1 | answered; **hypothesis refuted** |
| RQ9 | §11.0 | answered |
| RQ10 | §6.3 | answered, with the subjectivity threat stated |
| RQ11 | §17 | **partially** — memorisation indicator is coarse |
| RQ12 | §16 | answered |
...
whole ones. Three cells above say *partially*, one says *inconclusive*, and one requirement says
**not met**.
