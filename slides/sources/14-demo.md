...
**Spoken handoff, about fifteen seconds, while moving to the browser:**
...
**Then hand off to the timed demo script. Four minutes. Do not improvise it.**

Browser should already be at the printed URL, one tab, no console, notifications off.

**Press Generate early and keep talking.** A warm generation is about thirteen seconds, a cold one
about thirty. Both are dead air if you stop, and both are enough time to explain the progress panel
if you do not. Suggested prompt: *a mountain and a rising sun*, style **Ukiyo-e** — the unambiguous
pass, and it reads well at a distance.

**Do not** generate with retro-poster. It is a partial pass; showcase it in words and generate with
a full pass.
