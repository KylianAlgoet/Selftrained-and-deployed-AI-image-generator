...
|---|---|---|---|---|---|
| 0 | Static interactive 3D skateboard viewer | RQ9: deck UV mapping, orientation, dynamic textures | React+Vite+TS+R3F scene, licensed deck model, orbit/zoom/reset, swap a test texture at runtime | Deck renders; rotate/zoom/reset work; test decal maps with correct nose–tail orientation; texture swaps without reload | not started |
